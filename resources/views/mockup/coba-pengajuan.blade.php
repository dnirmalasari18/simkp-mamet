                    ...
                    <div class="card-body card-block">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="corpname" name="corporation[name]" value="">
                            </div>
                            <div class="form-group">
                                <label><strong>Alamat</strong></label>
                                <input type="text" class="form-control" id="corpaddress" name="corporation[address]" value="">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><strong>Kota</strong></label>
                                <input type="text" class="form-control" id="corpcity" name="corporation[city]" value="">
                            </div>
                            <div class="form-group">
                                <label><strong>Kode Pos</strong></label>
                                <input type="text" class="form-control" id="corppost_code" name="corporation[post_code]" value="">
                            </div>
                            <div class="form-group">
                                <label><strong>Telp Kantor</strong></label>
                                <input type="text" class="form-control" id="corptelp" name="corporation[telp]" value="">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><strong>Jenis Bisnis</strong></label>
                                <input type="text" class="form-control" id="corpbusiness_type" name="corporation[business_type]" value="">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-lg-12" >
                            <button type="button" class="btn btn-primary" style="float:right; width:25%;">Ajukan</button>
                        </div>  
                    </div>
                </div>
            </div>
